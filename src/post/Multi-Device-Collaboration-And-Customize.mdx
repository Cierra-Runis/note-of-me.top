...
|    设备    |           型号            |                                                                         备注                                                                          |
| :--------: | :-----------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------: |
|    手机    |         Redmi K70         |                                                                 单 USB-C 口；蓝牙 5.4                                                                 |
|    平板    |   iPad Pro 2021 11 inch   |                                   蓝牙 5.0；单 USB-C 口，支持雷雳 /USB 4，向下兼容 DP、雷雳 3、USB 4、USB 3.1 gen2                                    |
|  蓝牙耳机  |      AirPods Pro II       |                                                                 单 USB-C 口；蓝牙 5.3                                                                 |
|    Mac     |        Mac mini M2        |                       双 USB-C 口，均支持雷雳 /USB 4，向下兼容 DP、雷雳 3、USB 4、USB 3.1 gen2；双 USB-A 口；单 HDMI 2.0 口；略                       |
|   显示器   | 泰坦军团 P2SA2V 4K 144 Hz | 单 DP 1.4 口；双 HDMI 2.1 口；支持 DSC；单 USB-C 口，支持 DP 输出、PD 65 W 供电；单 USB-B 口；两者其一作为双 USB-A 口上行，均支持 USB 3.0；单音频接口 |
| 笔记本电脑 |    拯救者 R7000P 2021     |      蓝牙 5.1；单 HDMI 2.1 口；双 USB-C 口，均支持 DP 1.4，其一支持 PD 100 W 供电、USB 3.2；四 USB-A 口，均支持 USB 3.1；单千兆网口；单音频接口       |
|    键盘    |  狼蛛客制化旗舰 F99 系列  |                            单 USB-C 口，回报率 1000 Hz；蓝牙 5.0，回报率 125 Hz；无线 2.4 G，回报率 1000 Hz；电池 8000 mAh                            |
...
首先显示器和笔记本电脑用 USB-C 转 [DP](https://en.wikipedia.org/wiki/DisplayPort) 的线连接起来，显示器能以 4K 144 Hz 的预期模式显示画面，接着将鼠标有线连接至显示器 USB-A 口，键盘 2.4 G 接收器至显示器 USB-A 口。

问题出现了，照理说这两外设应该连上笔记本电脑的，DP 协议是能够运送双向 USB 信号的，总之再连了根 USB-C 转 USB-B 的线，显示器设置使 USB-B 作为上行。

再就是显示器和 Mac 用双 USB-C 的线连接起来，显示器能以 4K 60 Hz 的 **惨淡** 模式显示画面。
