...
我们知道 Flutter 将判断是否使用了 `'split-per-abi'` 的 [Flag](https://oclif.io/blog/2019/02/20/cli-flags-explained), 是则在 `ABI_VERSION` 选择一个版本 `* 1000` 再加上构建号。官方解释见 [此链接](https://developer.android.com/studio/build/configure-apk-splits)。
