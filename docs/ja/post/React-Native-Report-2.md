...
そこでコンポーネントライブラリを探して、[React Native Paper](https://reactnativepaper.com) というライブラリを見つけた。[Material Design 3](https://m3.material.io) のデザインを採用しているが、Flutter の `Scaffold` のようなものはない。まあ何とか使えるレベルだ。
