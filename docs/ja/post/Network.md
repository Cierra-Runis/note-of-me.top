...
| :----------------: | :--------------------------: | :-------------------------------: | :-------------------: | :--------------------------------------------------------------------------------------: |
|       スマホ       |         [Redmi K70]          |                 -                 | Wi-Fi 7[^1]、Wi-Fi 6E |                           MLO；MIMO 2×2；[同時デュアルバンド]                            |
|       スマホ       |     [iPhone 16 Pro Max]      |                 -                 |        Wi-Fi 7        |                                         MIMO 2×2                                         |
|   ~~タブレット~~   | ~~[iPad Pro 11-inch (3rd)]~~ |               ~~-~~               |     ~~Wi-Fi 6E~~      |                      ~~2.4G、5G [同時デュアルバンド]；MIMO 80 MHz~~                      |
|     タブレット     |   [iPad Pro 11-inch (M5)]    |                 -                 |        Wi-Fi 7        |                                         MIMO 2×2                                         |
...
| ~~メインルーター~~ |     ~~[锐捷 RG-MA3063]~~     | ~~4 つの RJ45 ギガビットポート~~  |      ~~Wi-Fi 6~~      |     ~~最大 3000 Mb/s；MIMO 2×2；4 つのポートのいずれかを WAN ポートとして使用可能~~      |
|   メインルーター   |        [小米 AX3000T]        |   4 つの RJ45 ギガビットポート    |        Wi-Fi 6        | 最大 574 + 2402 ≈ 3000 Mb/s；MIMO 2×2；4 つのポートのいずれかを WAN ポートとして使用可能 |
