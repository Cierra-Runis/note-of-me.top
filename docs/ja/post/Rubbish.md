...
|            名前             |                             紹介                             |         名前         |                         紹介                         |
| :-------------------------: | :----------------------------------------------------------: | :------------------: | :--------------------------------------------------: |
|          [GitLab]           |              コードホスティングプラットフォーム              |  [JetBrains 全家桶]  |                   IDE の詰め合わせ                   |
|       [JetBairns AI]        |                        AI コード生成                         | [Visual Studio Code] |            Microsoft の軽量コードエディタ            |
|       [Visual Studio]       |                 大規模プロジェクト向けの IDE                 |  [JetBrains Fleet]   |                    AI コード生成                     |
...
|       [Unreal Engine]       |                        ゲームエンジン                        |        [.NET]        |    .NET クロスプラットフォーム開発フレームワーク     |
...
[団結引擎]: https://unity.cn/tuanjie/tuanjieyinqing
[Qt]: https://www.qt.io/
